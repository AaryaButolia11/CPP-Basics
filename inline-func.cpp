...
// A static variable is a variable that retains its value between function calls and has a fixed memory location throughout the program's lifetime. 
// Its exact behavior depends on the language being used.
